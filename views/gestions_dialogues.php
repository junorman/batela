            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="contaiSner-fluid">
                        ...
                        <div class="row">
                            <h4 class="my-3">Gestions des dialogues</h4>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="card" style="border: 3px solid <?php echo BORDER_CARD_H ?>;">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4"><i class="bx bx-user-plus"></i> Ajouter un dialogue</h4>
                           ...
                           <div class="col-md-8">
                               <div class="row">
                                <div class="col-12">
                                    <div class="card" style="border: 3px solid <?php echo BORDER_CARD_H ?>;">
                                        <div class="card-body load_gestions_dialogues">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" name="gestions_dialogues">
                            <div class="row">
                                <div class="col-md-12">
                                     <div class="mb-3">
            ...
            $(document).ready(function(){
                ...
                $('.btn-add').click(function(e){
                    ...
                    if (libelle.length == '') {
                         $('#msg-libelle').show();
                         $('#msg-libelle').
                         html("Veuillez ajouter un dialogue ***").fadeIn();
                         $('#msg-libelle').focus();
                        ...
                        $.ajax({  
                        url:"./traitements/gestions_dialogues.php",  
                        method:"POST",  
