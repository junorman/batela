                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p style="color: <?php echo COLOR_H ?>;">Mot de passe oublié.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0" style="background: <?php echo MENU_N ?>;"> 
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="">
                                        ...
                                        <div class="mb-3">
                                            <label style="color: <?php echo COLOR_N ?>;" for="basicpill-phoneno-input">Adresse email</label>
                                        ...
                                        <div class="mb-3">
                                            <label style="color: <?php echo COLOR_N ?>;" for="basicpill-email-input">Ancien mot de passe</label>
                                            <input style="border: 3px solid <?php echo BORDER_H ?>;" type="password" class="form-control" id="pass" placeholder="Entrer l'ancien mot de passe">
                                            <span id="msg-pass"></span>
                                        </div>

                                        <div class="mb-3">
                                            <label style="color: <?php echo COLOR_N ?>;" for="basicpill-email-input">nouveau mot de passe</label>
                                            <input style="border: 3px solid <?php echo BORDER_H ?>;" type="password" class="form-control" id="pass2" placeholder="Entrer le nouveau mot de passe">
                                            <span id="msg-pass2"></span>
            ...
            $(document).ready(function(){
                ...
                $('.btn-login').click(function(e){
                    ...
                    if (email.length == '') {
                         ...
                         $('#msg-pass').show();
                         $('#msg-pass').
                         html("Veuillez saisir l'ancien mot de passe ***").fadeIn();
                         $('#msg-pass').focus();
                         ...
                         $('#msg-pass2').show();
                         $('#msg-pass2').
                         html("Veuillez saisir le nouveau mot de passe ***").fadeIn();
                         $('#msg-pass2').focus();
                         $('#msg-pass2').css("color", "red");
                         setTimeout(function(){
                         $('#msg-pass2').fadeOut('slow');
                         },5000);
                         return false;
                    }
                       ...
                       $.ajax({  
                        url:"./traitements/fortgot_pass.php",  
                        method:"POST",  
