...
<?php include 'header.php' ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <?php while($row = mysqli_fetch_array($consulter_notifications))
                            { ?>
                            <div class="card" style="border: 3px solid <?php echo BORDER_CARD_H ?>;">
                            <div class="card-body">
                                <ul class="list-unstyled chat-list" data-simplebar style="max-height: 410px;">
                                    <li class="active">
                                        <a href="?page=profil&id_profil=<?php echo $row['id_chauffeur'] ?>">
                                            <div class="d-flex">
                                                <!-- <div class="flex-shrink-0 align-self-center me-3">
                                                    <i class="mdi mdi-circle font-size-10"></i>
                                                </div> -->
                                                <div class="flex-shrink-0 align-self-center me-3">
                                                    <img src="img/profil/<?php echo $row['user_photo'] ?>" class="rounded-circle avatar-xs" alt="">
                                                </div>
                                                
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <p class="font-size-14 mb-1" <?php echo stateNotify($row['statut_vue']) ?>>
                                                        <?php echo $row['user_nom'].' '.$row['user_prenom'].' '.$row['id_user'] ?>
                                                    </p>
                                                    <p class="mb-1" key="t-simplified" <?php echo stateNotify($row['statut_vue']) ?>>Siganle: <?php echo $row['libelle_si'] ?></p>
                                                    <p class="mb-1" key="t-simplified" <?php echo stateNotify($row['statut_vue']) ?>>Problème: <?php echo $row['libelle_pro'] ?></p>
                                                ...
                                                <div class="font-size-11" <?php echo stateNotify($row['statut_vue']) ?>>
