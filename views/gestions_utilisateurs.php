            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="contaiSner-fluid">
                        ...
                        <div class="row">
                            <h4 class="my-3">Gestion utilisateurs</h4>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="card" style="border: 3px solid <?php echo BORDER_CARD_H ?>;">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4"><i class="bx bx-user-plus"></i> Nouveau utilisateur</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                               <div class="row">
                                <div class="col-12">
                                    <div class="card" style="border: 3px solid <?php echo BORDER_CARD_H ?>;">
                                        <div class="card-body load_gestions_utilisateurs">
            ...
            $(document).ready(function(){
                ...
                $('.btn-add').click(function(e){
                    ...
                    if (nom.length == '') {
                       ...
                       $.ajax({  
                        url:"./traitements/gestions_utilisateurs.php",  
                        method:"POST",  
