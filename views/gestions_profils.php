            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="contaiSner-fluid">
                        ...
                        <div class="row">
                            <h4 class="my-3">Gestions profils</h4>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    <div class="card" style="border: 3px solid <?php echo BORDER_CARD_H ?>;">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4"><i class="bx bx-user-plus"></i> Nouveau profil</h4>

                                            <form>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <input  type="text" class="form-control" id="libelle" placeholder="Entrer le profil">
                           ...
                           <div class="col-md-8">
                               <div class="row">
                                <div class="col-12">
                                    <div class="card" style="border: 3px solid <?php echo BORDER_CARD_H ?>;">
                                        <div class="card-body load_gestions_profils">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" role="form" name="profil_form">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <input  type="text" class="form-control" id="libelle2" placeholder="Entrer le profil">
            ...
            $(document).ready(function(){
                ...
                $('.btn-add').click(function(e){
                    ...
                    if (libelle.length == '') {
                       ...
                       $.ajax({  
                        url:"./traitements/gestions_profils.php",  
                        method:"POST",  
