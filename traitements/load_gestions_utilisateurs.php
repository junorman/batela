<?php 
 ...
 $consulter_users = mysqli_query($db, "SELECT * FROM users WHERE type='EMP' ORDER BY user_id DESC ");

 ?>

 <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
    <h4 class="card-title"><i class="bx bx-group"></i> Listes des utilisateurs</h4>
            ...
            $(document).ready(function(){
				...
				$('.btn-delete').click(function(e){
                    ...
                    swal({
	                    ...
	                    $.ajax({  
	                        url:"./traitements/supprimer_gestions_utilisateurs.php",  
	                        method:"POST",  
	                        data:{id:id},  
	                        success:function(res)  
	                        {     
                ...
                //load_gestions_utilisateurs();
                function load_gestions_utilisateurs(){

                    $.ajax({  
                        url:"./traitements/load_gestions_utilisateurs.php",  
                        method:"POST",/*  
                        data:{nom:nom},*/  
                        success:function(res)  
                        {     
                            
                            $('.load_gestions_utilisateurs').html(res);                              
                        },
                        cache: false  
                    });
                }
