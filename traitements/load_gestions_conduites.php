<?php 
 ...
 <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
    <h4 class="card-title"><i class="bx bx-group"></i> Listes des conduites</h4>
    ...
    <?php while ($row = mysqli_fetch_array($consulter_types_conduites)) {?>
    <tr>
        <td>
        ...
        <td>
        	...
        	<div class="btn-group">
                ...
                <div class="dropdown-menu">
					...
					document.gestions_conduites.libelle2.value='<?php echo $row['libelle_conduite']; ?>'
					document.gestions_conduites.id.value='<?php echo $row['id_type_conduite']; ?>'
                    ...
                    <button <?php echo deactivate_button($SUPPRIMER, SUPPRIMER) ?> id="<?php echo $row['id_type_conduite']; ?>" class="dropdown-item btn-delete">
            ...
            $(document).ready(function(){
                ...
                $('.btn-edit').click(function(e){
                    ...
                    if (libelle2.length == '') {
                         $('#msg-libelle2').show();
                         $('#msg-libelle2').
                         html("Veuillez saisir une conduite ***").fadeIn();
                         $('#msg-libelle2').focus();
		            ...
		            function(isConfirm){
		              if (isConfirm) {
                       ...
                       $.ajax({  
                        url:"./traitements/modifier_gestions_conduites.php",  
                        method:"POST",  
				...
				$('.btn-delete').click(function(e){
                    ...
                    swal({
	                    ...
	                    $.ajax({  
	                        url:"./traitements/supprimer_gestions_conduites.php",  
	                        method:"POST",  
	                        data:{id:id},  
	                        success:function(res)  
	                        {     
                ...
                function load_gestions_conduites(){

                    $.ajax({  
                        url:"./traitements/load_gestions_conduites.php",  
                        method:"POST",/*  
                        data:{nom:nom},*/  
                        success:function(res)  
                        {     
                            
                            $('.load_gestions_conduites').html(res);                              
                        },
                        cache: false  
                    });
                }
