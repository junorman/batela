<?php 
 ...
 <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
    <h4 class="card-title"><i class="bx bx-group"></i> Listes des vitesses</h4>
    ...
    <?php while ($row = mysqli_fetch_array($consulter_types_vitesses)) {?>
    <tr>
        <td>
        ...
        <td>
        	...
        	<div class="btn-group">
                ...
                <div class="dropdown-menu">
					...
					document.gestions_vitesses.libelle2.value='<?php echo $row['libelle_vi']; ?>'
					document.gestions_vitesses.id.value='<?php echo $row['id_type_vi']; ?>'
                    ...
                    <button <?php echo deactivate_button($SUPPRIMER, SUPPRIMER) ?> id="<?php echo $row['id_type_vi']; ?>" class="dropdown-item btn-delete">
            ...
            $(document).ready(function(){
                ...
                $('.btn-edit').click(function(e){
                    ...
                    if (libelle2.length == '') {
                         $('#msg-libelle2').show();
                         $('#msg-libelle2').
                         html("Veuillez saisir le type de vitesse ***").fadeIn();
                         $('#msg-libelle2').focus();
		            ...
		            function(isConfirm){
		              if (isConfirm) {
                       ...
                       $.ajax({  
                        url:"./traitements/modifier_gestions_vitesses.php",  
                        method:"POST",  
				...
				$('.btn-delete').click(function(e){
                    ...
                    swal({
	                    ...
	                    $.ajax({  
	                        url:"./traitements/supprimer_gestions_vitesses.php",  
	                        method:"POST",  
	                        data:{id:id},  
	                        success:function(res)  
	                        {     
                ...
                function load_gestions_vitesses(){

                    $.ajax({  
                        url:"./traitements/load_gestions_vitesses.php",  
                        method:"POST",/*  
                        data:{nom:nom},*/  
                        success:function(res)  
                        {     
                            
                            $('.load_gestions_vitesses').html(res);                              
                        },
                        cache: false  
                    });
                }
