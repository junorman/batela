<?php 
 ...
 <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
    <h4 class="card-title"><i class="bx bx-group"></i> Listes des activités</h4>
    ...
    <tr>
        <td style="width:1%">
        	<?php echo reduce_text2($row['libelle_obj']) ?>
        </td>
        <td>
        	<?php echo $row['description_obj'] ?>
        </td>
        ...
        <td>
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    ...
                    document.activites_form.libelle2.value='<?php echo addcslashes($row['libelle_obj'], "'"); ?>'
                    document.activites_form.details2.value='<?php echo addcslashes($row['description_obj'], "'"); ?>'
                    document.activites_form.id.value='<?php echo addcslashes($row['id_obj'], "'"); ?>'
                    ...
                    <button <?php echo deactivate_button($SUPPRIMER, SUPPRIMER) ?> id="<?php echo $row['id_obj']; ?>" class="dropdown-item btn-delete">
            ...
            $(document).ready(function(){
             $('.btn-edit').click(function(e){
                    ...
                    if (libelle2.length == '') {
                         $('#msg-libelle2').show();
                         $('#msg-libelle2').
                         html("Veuillez saisir l'intitulé ***").fadeIn();
                         $('#msg-libelle2').focus();
                         ...
                         return false;
                    }else if (details2.length == '') {
                         $('#msg-details2').show();
                         $('#msg-details2').
                         html("Veuillez saisir le détails ***").fadeIn();
                         $('#msg-details2').focus();
                         $('#msg-details2').css("color", "red");
                         setTimeout(function(){
                         $('#msg-details2').fadeOut('slow');
                         },5000);
                         return false;
                    }
                        ...
                        swal({
                      title: "Modification",
                      text: "Souhaitez vous modifier cette activités?",
                      type: "warning",
                    ...
                    function(isConfirm){
                      if (isConfirm) {
                       ...
                       $.ajax({  
                        url:"./traitements/modifier_gestions_activites.php",  
                        method:"POST",  
                        data:{libelle:libelle2, details:details2,
                           id:id},  
                ...
                $('.btn-delete').click(function(e){
                    ...
                    swal({
                          title: "supprimer",
                          text: "Souhaitez vous supprimer cette activités?",
                          type: "warning",
                          showCancelButton: true,
                          confirmButtonColor: "success",
                        ...
                        $.ajax({  
                            url:"./traitements/supprimer_gestions_activites.php",  
                            method:"POST",  
                            data:{id:id},  
                            success:function(res)  
                            {     
