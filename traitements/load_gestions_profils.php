<?php 
 ...
 $consulter_profils = mysqli_query($db, "SELECT * FROM profil WHERE id_profil!='1' ORDER BY id_profil DESC ");

 ?>

 <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
    <h4 class="card-title"><i class="bx bx-group"></i> Listes des profils</h4>
        ...
        <td>
        	...
        	<div class="btn-group">
                ...
                <div class="dropdown-menu">
					...
					document.profil_form.libelle2.value='<?php echo $row['libelle_profil']; ?>'
					document.profil_form.id.value='<?php echo $row['id_profil']; ?>'
                    ...
                    <button <?php echo deactivate_button($SUPPRIMER, SUPPRIMER) ?> id="<?php echo $row['id_op_div']; ?>" class="dropdown-item btn-delete">
            ...
            $(document).ready(function(){
                ...
                $('.btn-edit').click(function(e){
                    ...
                    if (libelle2.length == '') {
                         $('#msg-libelle2').show();
                         $('#msg-libelle2').
                         html("Veuillez saisir le profil ***").fadeIn();
                         $('#msg-libelle2').focus();
                    	...
                    	swal({
		              title: "Modification",
		              text: "Souhaitez vous modifier ce profil?",
		              type: "warning",
		            ...
		            function(isConfirm){
		              if (isConfirm) {
                       ...
                       $.ajax({  
                        url:"./traitements/modifier_gestions_profils.php",  
                        method:"POST",  
				...
				$('.btn-delete').click(function(e){
                    ...
                    swal({
		                  title: "supprimer",
		                  text: "Souhaitez vous supprimer ce profil?",
		                  type: "warning",
		                  showCancelButton: true,
		                  confirmButtonColor: "success",
	                    ...
	                    $.ajax({  
	                        url:"./traitements/supprimer_gestions_profils.php",  
	                        method:"POST",  
	                        data:{id:id},  
	                        success:function(res)  
	                        {     
                ...
                function load_gestions_profils(){

                    $.ajax({  
                        url:"./traitements/load_gestions_profils.php",  
                        method:"POST",/*  
                        data:{nom:nom},*/  
                        success:function(res)  
                        {     
                            
                            $('.load_gestions_profils').html(res);                              
                        },
                        cache: false  
                    });
                }
